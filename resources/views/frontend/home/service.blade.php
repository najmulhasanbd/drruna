    ...
    <div class="container">
        <div class="mb-5 text-center row justify-content-center">
            <div class="col-lg-7" data-aos="fade-up">
                ...
                <h2 class="mt-2 display-5 fw-bold text-dark">Expert Medical <span class="text-success">Services</span></h2>
                <div class="mx-auto mb-4 header-line"></div>
                <p class="text-muted">Specialized medical care focusing on high-risk pregnancy, fetal medicine, and gynecological excellence with over 18 years of experience.</p>
            </div>
        </div>
        ...
        <div class="row g-4">
                ...
                <article class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="p-4 border-0 shadow-sm service-card-premium h-100 rounded-4">
                        ...
                        <button class="p-0 bg-transparent border-0 btn-read-more text-primary fw-bold"
                            data-bs-toggle="modal" data-bs-target="#serviceModal{{ $item->id }}">
                            Read More <i class="fas fa-arrow-right ms-1"></i>
                        </button>
                    </div>
                </article>

                <div class="modal fade serviceModal" id="serviceModal{{ $item->id }}" tabindex="-1" aria-labelledby="modalLabel{{ $item->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="overflow-hidden border-0 shadow modal-content rounded-4">
                            <div class="py-3 text-white border-0 modal-header bg-success">
                                <h5 class="modal-title fw-bold" id="modalLabel{{ $item->id }}">Service Detail</h5>
                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="mb-4 text-center col-md-3 mb-md-0">
                                        <div class="mx-auto modal-icon-display rounded-circle bg-light text-success d-flex align-items-center justify-content-center" style="width: 80px; height: 80px; font-size: 30px;">
                                            {!! $item->icon !!}
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <h3 class="mb-3 fw-bold text-dark">{{ $item->title }}</h3>
                                        <div class="text-muted lh-lg">{!! $item->description !!}</div>
                                        <hr class="my-4">
                                        <a href="mailto:test@gmail.com" class="px-4 btn btn-success rounded-pill">BOOK AN APPOINTMENT</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            @empty
                <div class="py-5 text-center col-12">
                    <div class="border shadow-sm alert alert-light">
                        <p class="mb-0 text-muted">No services available at the moment. Please check back later.</p>
                    </div>
                </div>
            @endforelse

            <div class="mt-5 col-lg-12" data-aos="zoom-in">
                <div class="p-5 overflow-hidden text-white cta-banner-dark rounded-5 d-flex align-items-center justify-content-between position-relative">
                    <div class="cta-content position-relative z-2">
                        <h2 class="mb-3 display-6 fw-bold">I Provide Best <br> Medical Treatment.</h2>
                        <p class="mb-4 opacity-75 lead">Dr. Runa Akter: Dedicated, Highly Experienced & Compassionate.</p>
