                    ...
                    <div class="p-4 modal-body">
                        <form id="reviewForm">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control custom-input" rows="4" placeholder="How was your experience with Dr. Runa?"></textarea>
                            </div>
                            <button type="submit" class="py-2 shadow-sm btn btn-success w-100 fw-bold">Submit
                                Review</button>
                        </form>
                    </div>
                </div>
