        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-1 fw-bold text-dark">Edit Education</h3>
                        <p class="mb-0 text-muted">Update your academic credentials and details</p>
                    </div>
                    <a href="{{ route('education.index') }}" class="px-4 shadow-sm btn btn-outline-success rounded-pill">
                ...
                <div class="custom-card card">
                    <div class="card-header-gradient">
                        <h5 class="mb-0 fw-bold"><i class="fas fa-edit me-2"></i> Update Education Information</h5>
                    </div>
                        ...
                        <form action="{{ route('education.update', $education->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="mb-4 text-center col-md-12">
                                    ...
                                    <div class="image-upload-wrapper"
                                        ...
                                        <img id="preview" src="{{ asset($education->logo) }}" class="mb-3 preview-img">
                                        <input type="file" id="logoInput" name="logo"
                                            class="d-none @error('logo') is-invalid @enderror"
                                            onchange="previewImage(event)">
                                        <p class="mb-0 small text-muted">Click to change logo or leave empty to keep current
                                        </p>
                                        @error('logo')
                                ...
                                <div class="mb-4 col-md-12">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name', $education->name) }}" placeholder="e.g. Dhaka University"
                                        required>
                                    @error('name')
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" name="degree"
                                        ...
                                        value="{{ old('degree', $education->degree) }}" placeholder="e.g. B.Sc in CSE"
                                        required>
                                    @error('degree')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" name="session"
                                        ...
                                        value="{{ old('session', $education->session) }}" placeholder="e.g. 2018 - 2022"
                                        required>
                                    @error('session')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="gap-3 d-flex">
                                <button type="submit" class="shadow btn btn-success flex-grow-1 btn-update">
                                    <i class="fas fa-sync-alt me-2"></i> Update Education Record
                                </button>
