        ...
        <div class="row">
            <div class="mx-auto col-lg-10">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-end header-card">
                    <div>
                        <h3 class="mb-0 text-white fw-bold">Update Experience 💼</h3>
                        <p class="mb-0 text-white small">Modify your professional history records</p>
                    </div>
                            ...
                            <div class="row">
                                <div class="mb-5 text-center col-12">
                                    ...
                                    <div class="mx-auto col-md-7">
                                        ...
                                        <span class="info-tag"><i class="fas fa-info-circle me-1"></i> লোগো পরিবর্তন না করতে
                                            চাইলে ঘরটি খালি রাখুন।</span>
                                        @error('logo')
                                ...
                                <div class="mb-4 col-md-12">
                                    <label class="form-label"><i class="fas fa-hospital me-1 text-success"></i> Institute
                                        Name <span class="text-danger">*</span></label>
                                    <input type="text" name="name"
                                        class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name', $experience->name) }}" placeholder="Enter institute name"
                                        required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4 col-md-6">
                                    <label class="form-label"><i class="fas fa-calendar-alt me-1 text-success"></i> Session
                                        <span class="text-danger">*</span></label>
                                    <input type="text" name="session"
                                        class="form-control @error('session') is-invalid @enderror"
                                        value="{{ old('session', $experience->session) }}" placeholder="e.g. 2018 - 2023"
                                        required>
                                    @error('session')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-4 col-md-12">
                                    <label class="form-label"><i class="fas fa-align-left me-1 text-success"></i>
                                        Description</label>
