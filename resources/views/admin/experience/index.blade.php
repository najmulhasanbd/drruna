        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-1 fw-bold text-dark">Professional Experience</h3>
                        <p class="mb-0 text-muted">A list of all your clinical and academic positions.</p>
                    </div>
                    <a href="{{ route('experience.create') }}" class="px-4 shadow-sm btn btn-success fw-bold"
