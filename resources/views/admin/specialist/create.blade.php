                ...
                <div class="custom-card card">
                    <div class="card-header-gradient d-flex justify-content-between align-items-center">
                        <h4 class="card-title-main">
                            <i class="fas fa-user-md me-3"></i> Add Specialist
                        </h4>
                    ...
                    <div class="p-4 card-body p-md-5">
                        <form action="{{ route('specialist.store') }}" method="POST">
                            ...
                            <div class="mb-5">
                                <label class="form-label">Specialist / Department Name <span class="text-danger">*</span></label>
                                ...
                                <div class="mt-2 text-muted" style="font-size: 0.75rem;">
                                    <i class="fas fa-info-circle me-1"></i> This name will be displayed as a specialty category.
                                </div>
                            </div>
