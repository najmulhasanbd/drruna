...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <h3 class="mb-0">Add New Award</h3>
        </div>
    </div>
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="border-0 shadow-sm card">
                        <div class="py-3 bg-white card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 text-primary">Award Information</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            value="{{ old('name') }}" placeholder="Enter award name">
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        {{-- Input-er poriborte Textarea --}}
                                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="4"
                                            placeholder="award descrition">{{ old('description', isset($education) ? $education->description : '') }}</textarea>
