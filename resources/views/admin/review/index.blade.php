        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center header-card">
                    <div>
                        <h3 class="mb-1 text-white fw-bold">Client Reviews</h3>
                        <p class="mb-0 text-white">Manage testimonials and feedback from your clients.</p>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @forelse ($review as $key => $item)
                                        <tr>
                                            ...
                                            <td><span class="text-secondary small fw-medium">{{ $item->workplace }}</span>
                                            </td>
                                            <td>
                                                <div class="text-muted small">
                                                    {{ Str::limit($item->message, 40) }}
                                                    <span class="btn-more" data-bs-toggle="modal"
                                            ...
                                            <td>
                                                <span
                                                    class="status-badge {{ $item->status == 'pending' ? 'status-pending' : 'status-active' }}">
                                                    <i
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="gap-2 d-flex justify-content-end">
                                                    <a href="{{ route('review.status', $item->id) }}"
                                                        ...
                                                        <i
                                                            class="fas {{ $item->status == 'pending' ? 'fa-check' : 'fa-undo' }} fa-sm"></i>
                                                    </a>
                                                    ...
                                                    <form action="{{ route('review.destroy', $item->id) }}" method="POST">
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="text-white shadow-sm btn-action bg-danger "
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="border-0 shadow modal-content" style="border-radius: 15px;">
                                                    ...
                                                    <div class="p-4 modal-body">
                                                        <div class="mb-3 d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <small
                                                                    class="text-success fw-medium">{{ $item->workplace }}</small>
                                                            </div>
                                                        </div>
                                                        <div class="p-3 rounded-3 bg-light text-dark"
                                                    ...
                                                    <div class="p-3 border-0 modal-footer">
                                                        <button type="button"
                                                            class="px-4 btn btn-secondary rounded-pill btn-sm"
